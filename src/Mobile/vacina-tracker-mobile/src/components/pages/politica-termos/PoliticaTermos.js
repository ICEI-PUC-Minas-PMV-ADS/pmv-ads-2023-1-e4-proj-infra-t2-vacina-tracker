...
=======
export default function PoliticaTermos({navigation}) {
>>>>>>> 1cde6d42f09e59c4bd4734b432110d24317ce090
  ...
  return (
    <View style={styles.containerPolitica}>
      ...
      <Text style={styles.textTitulo1}>Política de Privacidade</Text>
      ...
      <Text style={styles.InformacoesSubText}>
        ...
        Dessa forma, a doravante denominada simplesmente como “Vacina Tracker” (nome fictício), inscrita no CNPJ/MF sob o nº 004.597.592/0001-20 (número fictício), no papel de Controladora de Dados, obriga-se ao disposto na presente Política de Privacidade.{"\n"}
        {"\n"}
        ...
        - Ao preencher o Formulário de Esqueceu a Senha{"\n"}
        - Ao preencher o Formulário de Fale Conosco{"\n"}
        - Ao editar o Perfil Cadastrado   {"\n"}
        2.1. Consentimento{"\n"}
        É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza a “Vacina Tracker” (nome fictício) a tratar seus dados.{"\n"}
        ...
        O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé da “Vacina Tracker” (nome fictício) para com seus usuários/clientes, seguindo as regulações legislativas pertinentes.{"\n"}
        Ao utilizar os serviços da “Vacina Tracker” (nome fictício) e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los.{"\n"}
        ...
        A “Vacina Tracker” (nome fictício) assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:{"\n"}
        ...
        - Solicitar a portabilidade de seus dados, através de um relatório de dados cadastrais que a “Vacina Tracker” (nome fictício) trata a seu respeito.{"\n"}
        ...
        Para exercer seus direitos de titular, você deve entrar em contato com a “Vacina Tracker” (nome fictício) através dos seguintes meios disponíveis:{"\n"}
        - vacinatracker@hotmail  {"\n"}
        - (31) 98925-9223{"\n"}
        - (31) 3256-9851{"\n"}
        ...
        A “Vacina Tracker” (nome fictício) faz uso de Cookies, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso.{"\n"}
        ...
        A “Vacina Tracker” (nome fictício) utiliza os seguintes Cookies: (descrição dos tipos de Cookies utilizados pelo site).{"\n"}
        ...
        A atual versão da Política de Privacidade foi formulada e atualizada pela última vez em: 01/11/2022.{"\n"}
        ...
        10. Responsabilidade{"\n"}
        A “Vacina Tracker” (nome fictício) prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados.{"\n"}
        ...
        Caso a Autoridade Nacional de Proteção de Dados exija a adoção de providências em relação ao tratamento de dados realizado pela “Vacina Tracker” (nome fictício), comprometemo-nos a segui-las.{"\n"}
        10.1 Isenção de responsabilidade{"\n"}
        Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhuma página virtual inteiramente livre de riscos.
        Nesse sentido, a “Vacina Tracker” (nome fictício) não se responsabiliza por:{"\n"}
        ...
        III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços da “Vacina Tracker” (nome fictício); quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.{"\n"}
        {"\n"}

        11. Encarregado de Proteção de Dados{"\n"}
        A “Vacina Tracker" (nome fictício) disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: vacinatracker@hotmail.com.{"\n"}
        Caso tenha dúvidas sobre esta Política de Privacidade ou sobre os dados pessoais que tratamos, você pode entrar em contato com o nosso Encarregado de Proteção de Dados Pessoais, através dos seguintes canais: vacinatracker@hotmail.com{"\n"}
        {"\n"}

        Fonte do Modelo: (https://legalcloud.com.br/modelo-politica-privacidade/#Modelo_de_Politica_de_Privacidade_da_Legalcloud_Copie_e_Cole){"\n"}
        Acessado em Abril deste ano.{"\n"}
        Texto Adaptado pelos Autores
      </Text>


      <Text style={styles.textTitulo2}>Termos e Condições de Uso</Text>

      <Text style={styles.InformacoesSubText}>
        {"\n"}Os serviços do “Vacina Tracker” (nome fictício) são fornecidos pela pessoa jurídica com a seguinte Razão Social/nome: Vacina Tracker (nome fictício), com nome fantasia “Vacina Tracker” (nome fictício), inscrito no CNPJ/CPF sob o nº 004.597.592/0001-20 (número fictício), titular da propriedade intelectual sobre software, website, aplicativos, conteúdos e demais ativos relacionados à plataforma Vacina Tracker.{"\n"}
        ...
        A plataforma caracteriza-se pela prestação do seguinte serviço: catálogo de vacinas aplicadas.{"\n"}
        A plataforma realiza a venda à distância por meio eletrônico dos seguintes produtos ou serviços: “biblioteca” de vacinas aplicadas.{"\n"}
        {"\n"}
        ...
        O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao aplicativo Vacina Tracker (nome fictício). O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.{"\n"}
        ...
        5. Do suporte{"\n"}
        Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do email vacinatracker@hotmail.com{"\n"}
        Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários: segunda a sexta-feira, de 08h às 17h.{"\n"}
        {"\n"}
        ...
        {"\n"}
        É de responsabilidade da plataforma Vacina Tracker (nome fictício):{"\n"}
        ...
        O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social Vacina Tracker (nome fictício), puníveis nos termos da legislação aplicável.{"\n"}
        {"\n"}

        8. Das sanções{"\n"}
        Sem prejuízo das demais medidas legais cabíveis, a razão social Vacina Tracker (nome fictício) poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:{"\n"}
        ...
        9. Da rescisão{"\n"}
        A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social Vacina Tracker (nome fictício) e o bloqueio de todos os serviços prestados ao usuário.{"\n"}
        {"\n"}

        10. Das alterações{"\n"}
        Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte de Vacina Tracker (nome fictício), para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas pelo aplicativo Vacina Tracker (nome fictício) e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.{"\n"}
        {"\n"}
        ...
        Fonte do Modelo: (https://pensadorjuridico.jusbrasil.com.br/modelos-pecas/784909844/modelo-termos-e-condicoes-para-site-ou-app){"\n"}
        Acessado em Abril deste ano.{"\n"}
        Texto Adaptado pelos Autores
      </Text>
